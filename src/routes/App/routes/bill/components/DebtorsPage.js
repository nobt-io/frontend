      ...
      <Main>
        ...
        <SectionGroup>
          <Section>
            ...
            <List>
              <CheckboxItem
                autoFocus={true}
                name="Everyone"
                selected={areAllMembersSelected}
                selectAction={() => setAllValues(!areAllMembersSelected)}
                noAvatar
              />
              <ListDivider />
              {shares.map(share => (
                <CheckboxItem
                  key={share.name}
                  name={share.name}
                  selected={share.value}
                  selectAction={(name, value) =>
          ...
          <Section>
            ...
            <List>
              <AddMemberItem
                placeholder="Sheldon, Penny, Leonard, ..."
                onNewMember={name => onNewMember(name)}
              />
            </List>
          </Section>
        </SectionGroup>
