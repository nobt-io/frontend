...
export const getNobtId = createSelector([ getCurrentNobt ], (nobt) => nobt.id);
...
const getBillId = (state, props) => parseInt(props.match.params.billId);
...
const getBalanceOwner = (state, props) => props.match.params.name;
